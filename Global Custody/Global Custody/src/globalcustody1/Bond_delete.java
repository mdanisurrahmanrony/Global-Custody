 ...
 * @author Foysal
 */
public class Bond_delete extends javax.swing.JFrame {

    /**
     * Creates new form Bond_delete
     */
    public Bond_delete() {
        initComponents();
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(deletebtncusto, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(deletecustobtn, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(27, 27, 27)
                .addComponent(deletebtncusto, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void deletebtncustoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deletebtncustoActionPerformed
        ...
        if(p==0)
        {
            try{
                ...
                String sql="DELETE FROM bond WHERE Bond_id=?";
                PreparedStatement pst;
                pst = con.prepareStatement(sql);
                pst.setString(1,deletecustobtn.getText());
                pst.executeUpdate();
                JOptionPane.showMessageDialog(null,"Deleted Successfully");
                Bonds bst2=new Bonds();
                dispose();
...
//            java.util.logging.Logger.getLogger(Bond_delete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new Bond_delete().setVisible(true);
//            }
//        });
//    }
