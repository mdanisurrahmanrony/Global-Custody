 ...
 * @author Foysal
 */
public class Custodian_delete extends javax.swing.JFrame {

    /**
     * Creates new form Custodian_delete
     */
    public Custodian_delete() {
        initComponents();
    ...
    private void initComponents() {
        ...
        deletecustobtn = new javax.swing.JTextField();
        deletebtncusto = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("Custodian Delete");
        ...
        deletecustobtn.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        deletecustobtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                deletecustobtnActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(deletebtncusto, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(deletecustobtn, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(deletecustobtn, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void deletebtncustoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deletebtncustoActionPerformed
        ...
        if(p==0)
        {
            try{
                ...
                String sql="DELETE FROM custodian WHERE Custodian_id=?";
                PreparedStatement pst;
                pst = con.prepareStatement(sql);
                pst.setString(1,deletecustobtn.getText());
                pst.executeUpdate();
    ...
    private void deletecustobtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deletecustobtnActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_deletecustobtnActionPerformed
...
//            java.util.logging.Logger.getLogger(Custodian_delete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new Custodian_delete().setVisible(true);
//            }
//        });
//    }
    ...
    private javax.swing.JTextField deletecustobtn;
